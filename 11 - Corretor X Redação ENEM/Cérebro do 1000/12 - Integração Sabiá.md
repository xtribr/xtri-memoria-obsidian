...
Mesmo com C2 sendo chamada primeiro, a aba `Devolutiva` é preenchida como uma linha consolidada por redação, com colunas de nota, comentário e sugestão na ordem C1, C2, C3, C4 e C5.
